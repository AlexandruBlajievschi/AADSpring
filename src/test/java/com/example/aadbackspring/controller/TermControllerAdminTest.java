...
public class TermControllerAdminTest {
    ...
    @Test
    public void testCreateTerm_AsAdmin_Success() throws Exception {
    ...
    @Test
    public void testGetAllTerms_AsAdmin_Success() throws Exception {
    ...
    @Test
    public void testGetTermById_AsAdmin_Success() throws Exception {
    ...
    @Test
    public void testGetTermById_AsAdmin_NotFound() throws Exception {
    ...
    @Test
    public void testUpdateTerm_AsAdmin_Success() throws Exception {
    ...
    @Test
    public void testUpdateTerm_AsAdmin_NotFound() throws Exception {
        Term updateData = new Term();
    ...
    @Test
    public void testDeleteTerm_AsAdmin_Success() throws Exception {
    ...
    @Test
    public void testDeleteTerm_AsAdmin_NotFound() throws Exception {
