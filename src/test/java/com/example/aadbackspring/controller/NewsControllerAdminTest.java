...
public class NewsControllerAdminTest {
    ...
    // ---- CREATE NEWS (Admin Success) ----
    @Test
    public void testCreateNews_AsAdmin_Success() throws Exception {
    ...
    // ---- GET ALL NEWS (Admin can GET) ----
    @Test
    public void testGetAllNews_AsAdmin_Success() throws Exception {
        mockMvc.perform(get("/news"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$", hasSize(greaterThanOrEqualTo(1))));
    }

    // ---- GET NEWS BY ID (Admin can GET) ----
    @Test
    public void testGetNewsById_AsAdmin_Success() throws Exception {
    ...
    @Test
    public void testGetNewsById_AsAdmin_NotFound() throws Exception {
        mockMvc.perform(get("/news/{id}", 999L))
                .andExpect(status().isNotFound())
                .andExpect(content().string(containsString("News not found")));
    }

    // ---- UPDATE NEWS (Admin Success) ----
    @Test
    public void testUpdateNews_AsAdmin_Success() throws Exception {
    ...
    @Test
    public void testUpdateNews_AsAdmin_NotFound() throws Exception {
        News updateData = new News();
    ...
    // ---- DELETE NEWS (Admin Success) ----
    @Test
    public void testDeleteNews_AsAdmin_Success() throws Exception {
    ...
    @Test
    public void testDeleteNews_AsAdmin_NotFound() throws Exception {
